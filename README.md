...
5. If the browser doesnt open up, then open <ip_address>:8240 and complete setup

6. Access the server remotely from outside using IP address provided by Tailscale. Eg IP_Tailscale:3000 and Grafana dashboards from IP_Tailscale:3001
